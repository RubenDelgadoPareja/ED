...
/**
 @brief Funcion de búsqueda de una clave por la primera letra
 @param letra: letra por la que buscamos
 @param D: diccionario donde se realizará la búsqueda
 @return Devuelve la lista de clave del diccionario que empiecen por esa letra
 */
...
/**
 @brief Funcion para imprimir un diccionario en sentio contrario al alfabetico
 @param D: diccionario que se va a imprimir
 @return nada
 */
...
/**
 @brief Funcion para busqueda de una clave por la definicion
 @param def: lista de definiciones de la clave
 @param D: Diccionario donde se realiza la busqueda
 @return La clave que le corresponde esa definicon
 */
...
/**
 @brief Funcion que borra todas las definiciones de una clave introducida
 @param clave: la clave que se van a borrar sus definiciones
 @param D: diccionario donde se van a realizar los cambios
 @return nada
 */
void BorraDefinicion(string clave, Diccionario<string,string> &D){
	//Diccionario<string,string>::iterator it = D.begin();
	//No me deja hacerlo con otro iterator
